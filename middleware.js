const { bandschema, reviewSchema } = require('./schemas.js');
...
module.exports.validateband = (req, res, next) => {
    const { error } = bandschema.validate(req.body);
    if(error){
